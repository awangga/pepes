...
<head>
    ...
    {{ stylesheet_link("HTML/assets/css/style.css") }}
    {{ stylesheet_link("HTML/assets/css/loader-style.css") }}
    {{ stylesheet_link("HTML/assets/css/bootstrap.css") }}
    {{ stylesheet_link("HTML/assets/js/button/ladda/ladda.min.css") }}
    ...
    <!--[if lt IE 9]>
        ...
        <![endif]-->
    <!-- Fav and touch icons -->
    {{ stylesheet_link("HTML/assets/ico/minus.png") }}
</head>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                $z=count($breadcrumb)-1;for($a=0;$a<=$z;$a++){?>
                <li><a href="#" title="<?php echo $breadcrumb[$a]; ?>"><?php echo $breadcrumb[$a]; ?></a>
                <?php if($a!=$z){?>
        ...
        {{ javascript_include("HTML/assets/js/preloader.js") }}
        {{ javascript_include("HTML/assets/js/bootstrap.js") }}
        {{ javascript_include("HTML/assets/js/app.js") }}
        {{ javascript_include("HTML/assets/js/load.js") }}
        {{ javascript_include("HTML/assets/js/main.js") }}
