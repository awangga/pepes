<?php echo $this->tag->tagHtml('div', array('class' => 'page-header')); ?>
    <?php echo $this->tag->tagHtml('h1'); ?> Sending sms!<?php echo $this->tag->tagHtmlClose('h1'); ?>
...
<form class="form-horizontal" role="form" method="post">
  <div class="form-group">
    ...
    <div class="col-sm-10">
		<?php echo $this->tag->textField(array('rcpt', 'class' => 'form-control', 'placeholder' => '081100000,08880909121,089900000')); ?>
    </div>
  </div>
  <div class="form-group">
